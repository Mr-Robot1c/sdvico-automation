...
export async function generateSocialPost({
  ...
  const system = [
    ...
    // 11/9 tối: 2 câu nhịp 3 và 4 viết lại theo SỰ THẬT NGHỀ (product-guard sea40: tàu cá cố ý chở nước để dằn tàu),
    // nhấn chủ động nước ngọt sạch giữa chuyến, không cắt chuyến quay bờ. test-price-teaser.mjs quét khối này.
    'Cái máy lọc nước biển SEA-40 lo đúng chuyện đó: biến nước biển thành nước ngọt ngay trên tàu, chạy bằng điện tàu sẵn có. Nước mới ra mỗi ngày, cả tàu uống, nấu, tắm rửa thoải mái, không phải nhìn can mà dè sẻn.',
    'Nghĩa là mình chủ động nước ngọt sạch giữa chuyến, cá đang vào thì cứ bám luồng mà đánh, không phải cắt chuyến quay bờ chỉ vì hết nước.',
  ...
  // có dấu cách). Bản sao y hệt ở packages/marketing/src/social.mjs.
