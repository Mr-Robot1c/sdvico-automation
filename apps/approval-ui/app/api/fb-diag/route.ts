...
export async function GET(req: Request) {
  ...
  if (TOKEN && oid) {
    try {
      const fields = 'id,description,title,length,created_time,updated_time,privacy,status,published,embeddable,permalink_url,live_status,picture,content_category,universal_video_id,is_reference_only,post_id';
