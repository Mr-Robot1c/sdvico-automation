...
export async function GET(req: NextRequest) {
  ...
  const buf = await buildRecruitmentPoster({
    ...
    benefits: ['Thưởng theo năng lực', 'BHXH, BHYT đầy đủ', 'Có xe đưa rước hàng ngày'],
    salary: q.get('salary') || '8 - 12 triệu/tháng',
    workingHours: q.get('gio_lam') || '8h - 17h, nghỉ Chủ nhật',
