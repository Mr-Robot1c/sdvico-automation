  ...
  return (
    <main>
      ...
      <p className="sub" style={{ marginBottom: 16 }}>
        Máy tự phân loại: hỏi thêm chi tiết thì soạn câu mời nhắn Messenger (chờ ở đây, người bấm
        Duyệt mới đăng) · khen/ủng hộ thì máy tự react like, không cần duyệt · còn lại thì bỏ qua.
        Xem &quot;Lịch sử gần đây&quot; bên dưới để biết bình luận đã được xử lý ra sao.
      </p>
