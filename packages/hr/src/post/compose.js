...
export function composePosting({ title, jobBoardBody, targeting, salary = 'Thỏa thuận', email = process.env.HR_CONTACT_EMAIL || 'inoudead@gmail.com', fallbackLocation = 'Vũng Tàu' }) {
