...
ttl_days: 180
<!-- re-verified: 2026-08-14 - Day chuyen video 3 nang cap: (1) FIT-IN-BLUR: assemble.mjs filter moi giu nguyen ty le anh goc (khong crop, khong meo); anh khac ty le khung thi phu 2 ben bang chinh anh do phong to + boxblur 20 (kieu TikTok/Reels). Anh ngang ep vao doc va nguoc lai deu dep. (2) INTRO + OUTRO: bumpers.mjs ve intro (logo + slogan, 2.5s) va outro (tong dai 1900 23 23 49 to, 4s) bang @napi-rs/canvas, ffmpeg tao mp4 cung codec cac canh de concat -c copy. Outro co TTS "Goi ngay tong dai..." doc tung chu so qua spellPhones. Loi bumpers -> bo qua, khong chan pipeline. (3) build-video: truyen outroAudioPath vao assembleVideo. --><!-- DOC-STATUS: SUSPECT (2026-08-14) — code 'packages/marketing' doi sau last_verified. DOI CHIEU VOI CODE truoc khi tin. May quan ly dong nay, dung sua tay. -->
