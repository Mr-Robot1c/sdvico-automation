...
<!-- re-verified: 2026-08-27 17:50 - VIDEO TREND thanh 9:16 vertical (YouTube Short + TikTok) - user 27/8: "video trend toi muon la Short chu khong phai video thuong + chua the dang tiktok". FIX buildTrendVideoFromPexels: W/H 1920x1080 -> 1080x1920 (dung o scale filter tat ca canh + Ken Burns image); subtitle FontSize 20 -> 32 + MarginV 40 -> 140 (video doc); brief.assets luu them video_v = asset.id (giu .video cho backward-compat) - nut "Xuat TikTok" o /noi-dung/bang-section.tsx check video_v moi hien duoc. YT publish description da co #Shorts (youtube-publish.ts line 116) -> dua video doc + duration <60s + #Shorts -> YT nhan la Short. -->
