...
ttl_days: 180
<!-- DOC-STATUS: SUSPECT (2026-08-27) — code 'packages/marketing' doi sau last_verified. DOI CHIEU VOI CODE truoc khi tin. May quan ly dong nay, dung sua tay. -->
<!-- re-verified: 2026-08-27 18:20 - VIDEO TREND giong dong deu ca video (user 27/8: "giong o gan cuoi video khong dong deu"). Bug cu: moi canh doc lap thu Gemini roi fallback edge -> canh 1-4 giong Leda (Gemini OK), canh cuoi Gemini rate-limit -> giong HoaiMy (edge). FIX buildTrendVideoFromPexels tach TTS ra thanh 2 pass: (1) TTS pass 1 thu Gemini cho TAT CA canh - neu ANY canh fail thi allGeminiOK=false, break; (2) TTS pass 2 (chi neu !allGeminiOK): re-TTS TOAN BO bang edge -> dong deu ca video. Ghep clip THEM loudnorm=I=-16:LRA=11:TP=-1.5 + -ar 44100 -> can am luong giua cac canh (moi TTS engine xuat volume khac nhau ~3-6dB). -->
