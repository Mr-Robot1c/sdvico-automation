...
<!-- re-verified: 2026-09-14 - INTRO CLIP THUONG HIEU (sep 14/9 gui intro-2026-Q3.mp4): bumpers.mjs buildBumpers ban DOC dung assets/intro-doc.mp4 (cat 0-4,0s dung diem doi canh, fade tieng 0,4s cuoi, 2,6 MB, .gitignore ngoai le *.mp4) qua renderIntroFromClip (ma hoa lai H.264 yuv420p 30fps timescale 30000 AAC 44100 stereo de concat -c copy); thieu file / ban ngang -> ve canvas nhu cu; env INTRO_CLIP doi clip. Da dung thu 00d9768a: decode sach, cat sang canh 1 dung 4,0s. LUU Y: clip mang slogan "Nghề cá thịnh vượng" trong khi outro canvas van "SDVICO đồng hành cùng ngư dân" (slogan cu 4/9 giu). -->
