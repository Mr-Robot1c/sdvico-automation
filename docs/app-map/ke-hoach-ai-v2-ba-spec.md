...
<!-- re-verified: 2026-09-05 sang - GIONG NHANH + TUOI (sep 5/9: cac sep che giong "ngang ngang phe phe"): build-video.mjs them livelyArgs() -> ffmpeg -af asetrate/aresample/atempo cho giong LOCAL (VieNeu 48kHz) va GEMINI; mac dinh tempo 1.12 + pitch +1 semitone (mau 2 trong 5 mau sep nghe 5/9), env TTS_TEMPO / TTS_PITCH_SEMI. Dung ffmpeg atempo (WSOLA) thay librosa time_stretch bi che re 28/8. edge giu rate/pitch rieng. -->
