...
<!-- re-verified: 2026-09-14 (2) - KICH BAN VIDEO BAN HANG DOI KIEU MO (sep 14/9: "dung cu mai mat luong ca lon, dung giong nhau qua"): script.mjs SALES_STYLES 6 kieu mo xoay theo bam id (nghich-ly / con-so / loi-tho-may / thoi-quen-sai / giac-quan / truoc-sau, env VIDEO_SALES_STYLE ghi de), moi kieu kem 1 tinh huong mat mat; SALES_WORN 20 cum cam ("trúng luồng cá", "quay vào bờ", "xót đứt ruột", "vợ con ở nhà", "nằm bờ cả tuần"...) + soat sau khi sinh, dinh thi sinh lai 1 lan (dung co che worn cua video content); vi du canh empathy bo cac cum cu. products.mjs (2 ban) ensureSpokenTeaser so khop chuan hoa ("3X"/"9,X" = "3 X"/"9 phẩy X") -> het doc gia 2 lan. Thu 3 bai: 2 kieu mo khac nhau, 0 cum mon. -->
<!-- re-verified: 2026-09-07 trua (3) - /ke-hoach o Muc tieu tuan rong hon (rows 12, min-height 280px, resize doc) de nguoi giao viec doc het muc tieu nhieu doan; chi tiet README cung gio. Flow BOSS de xuat / NGUOI quyet KHONG doi. -->
<!-- re-verified: 2026-09-07 trua (2) - /ke-hoach bo 2 nut trend / 7 bai, o gio dang rong hon, 9 group chia se (chi tiet README cung gio). Flow BOSS de xuat / NGUOI quyet KHONG doi. -->
<!-- re-verified: 2026-09-07 trua - HOTFIX /ke-hoach sap vi tier "manual" (chi tiet README cung gio): Tier them manual = nguoi dat uu tien tay, bang San pham uu tien hien "Uu tien tay", tier la khong lam sap trang. Flow BOSS de xuat / NGUOI quyet KHONG doi. -->
...
<!-- re-verified: 2026-09-14 - INTRO CLIP THUONG HIEU (sep 14/9 gui intro-2026-Q3.mp4): bumpers.mjs buildBumpers ban DOC dung assets/intro-doc.mp4 (14/9 (2) sep che on + dai: cat 0-3,3s dung luc slogan hien xong, tieng -14 dB + fade 0,5s cuoi, 2,4 MB, .gitignore ngoai le *.mp4) qua renderIntroFromClip (ma hoa lai H.264 yuv420p 30fps timescale 30000 AAC 44100 stereo de concat -c copy); thieu file / ban ngang -> ve canvas nhu cu; env INTRO_CLIP doi clip. Da dung thu 00d9768a: decode sach, cat sang canh 1 dung 4,0s. LUU Y: clip mang slogan "Nghề cá thịnh vượng" trong khi outro canvas van "SDVICO đồng hành cùng ngư dân" (slogan cu 4/9 giu). -->
...
ttl_days: 90
<!-- DOC-STATUS: SUSPECT (2026-09-16) — code 'apps/approval-ui/app/ke-hoach' doi sau last_verified. DOI CHIEU VOI CODE truoc khi tin. May quan ly dong nay, dung sua tay. -->
...
<!-- re-verified: 2026-08-29 - Audit dot 3 cham vung covers nhung KHONG doi flow ke hoach: migration 20260829180000 them ham reserve_daily_quota (chi tiet o database.md); rotate them ve slot nguyen tu chan 2 luot cung luc (bai sinh ra van bam plan nhu cu); build-video-all them attempts/claim/run_log. NV/AC spec khong doi. -->
<!-- re-verified: 2026-08-28 17:45 - Ap ke hoach thang 9 SOM theo lenh sep (user 28/8 chieu): goal = thang goc 4 tuan can theo tuan T2 (31/8-6/9 noi dau, 7-13/9 tien, 14-20/9 nguoi that, 21-27/9 mua vu); ep sinh ban weekly qua /api/mkt-metrics-pull?plan=weekly -> plan 8c3e8e29 ap ngay: 10 huong (7 moi dung khung 2-2-1-1-1 bam nac 1 + 3 carry 70/30), toan bo loc dau/loc nuoc, SD12-300 tham gia 3 huong (folder 9 da co 4 anh user up, bug upload khong gan folder da sua o actions/uploader). NV/AC flow khong doi — chi du lieu + lich. -->
